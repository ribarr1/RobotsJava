...
public class MOV_CIERRE_CONTABLE {
	String cod_entidad;
	String cod_legado;
	String id_tanda;
	Date fec_creacion;
	Date fecha_cierre_contable;
	...
	public Date getFecha_cierre_contable() {
		return fecha_cierre_contable;
	}
	public void setFecha_cierre_contable(Date fecha_cierre_contable) {
		this.fecha_cierre_contable = fecha_cierre_contable;
	}
