...
public class MAE_CONTRATOS_DATOS_DINAMICOS {
	String cod_entidad;
	String cod_legado;
	String id_tanda;
	Date fec_creacion;
	String num_contrato;
	Integer tasa_corriente_ea;
	Integer tasa_mora_ea;
	String estado_causacion;
	...
	public Integer getTasa_corriente_ea() {
		return tasa_corriente_ea;
	}
	public void setTasa_corriente_ea(Integer tasa_corriente_ea) {
		this.tasa_corriente_ea = tasa_corriente_ea;
	}
	public Integer getTasa_mora_ea() {
		return tasa_mora_ea;
	}
	public void setTasa_mora_ea(Integer tasa_mora_ea) {
		this.tasa_mora_ea = tasa_mora_ea;
	}
	public String getEstado_causacion() {
		return estado_causacion;
	}
	public void setEstado_causacion(String estado_causacion) {
		this.estado_causacion = estado_causacion;
	}
