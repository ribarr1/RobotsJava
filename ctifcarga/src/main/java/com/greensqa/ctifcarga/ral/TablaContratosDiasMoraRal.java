...
public class TablaContratosDiasMoraRal {
	 public static void main(String[] parametro) throws SQLException {
		 ...
		 PreparedStatement pstmt = ConnectionBuilder.buildConnection().prepareStatement("insert into inbox.MAE_CONTRATOS_DIAS_MORA (\r\n" + 
			"COD_ENTIDAD, COD_LEGADO, ID_TANDA, FEC_CREACION, NUM_CONTRATO, COD_GRUPO_CONCEPTO, DIAS_MORA, NUM_CUOTAS_VENCIDAS, "
			+ "ID_FILA_ORIGEN_LEGADO, ESTADO_REGISTRO, ID_EXPORT, FECHA_EXPORT, USUARIO_CREACION, FEC_ACTUALIZ, "
