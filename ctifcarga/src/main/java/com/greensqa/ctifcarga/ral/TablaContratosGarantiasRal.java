...
public class TablaContratosGarantiasRal {
	 public static void main(String[] parametro) throws SQLException {
		 ...
		 PreparedStatement pstmt = ConnectionBuilder.buildConnection().prepareStatement("insert into inbox.MAE_CONTRATOS_GARANTIAS (\r\n" + 
	...
	int i = 1;
	   while (i <= 10000) {
		 System.out.println("  "+i);
		    ...
		    registro.setPorctj_idonea(1 + (rnd.nextInt(999 + 1) - 1)); 
		    registro.setPorctj_otras(1 + (rnd.nextInt(999 + 1) - 1));
		    ...
		    pstmt.setInt(6, registro.getPorctj_idonea());
		    pstmt.setInt(7, registro.getPorctj_otras());
		    pstmt.setDate(8, (Date) registro.getFec_corte_contbl());	
