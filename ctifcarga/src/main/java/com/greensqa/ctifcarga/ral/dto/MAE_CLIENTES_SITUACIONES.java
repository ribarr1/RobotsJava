...
public class MAE_CLIENTES_SITUACIONES {
	String cod_entidad;
	String cod_legado;
	String id_tanda;
	Date fec_creacion;
	Integer cod_tipo_ident;
	String id_cliente;
	Integer cod_situacion_cliente;
	...
	public Integer getCod_tipo_ident() {
		return cod_tipo_ident;
	}
	public void setCod_tipo_ident(Integer cod_tipo_ident) {
		this.cod_tipo_ident = cod_tipo_ident;
	}
	...
	public Integer getCod_situacion_cliente() {
		return cod_situacion_cliente;
	}
	public void setCod_situacion_cliente(Integer cod_situacion_cliente) {
		this.cod_situacion_cliente = cod_situacion_cliente;
	}
