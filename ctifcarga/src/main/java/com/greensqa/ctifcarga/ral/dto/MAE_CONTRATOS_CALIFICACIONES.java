...
public class MAE_CONTRATOS_CALIFICACIONES {
	
	String cod_entidad;
	String cod_legado;
	String id_tanda;
	Date fec_creacion;
	String cod_legado_fuente;
	String num_contrato;
	String cod_calif_excepcional;
	...
	public String getCod_legado_fuente() {
		return cod_legado_fuente;
	}
	public void setCod_legado_fuente(String cod_legado_fuente) {
		this.cod_legado_fuente = cod_legado_fuente;
	}
	...
	public String getCod_calif_excepcional() {
		return cod_calif_excepcional;
	}
	public void setCod_calif_excepcional(String cod_calif_excepcional) {
		this.cod_calif_excepcional = cod_calif_excepcional;
	}
