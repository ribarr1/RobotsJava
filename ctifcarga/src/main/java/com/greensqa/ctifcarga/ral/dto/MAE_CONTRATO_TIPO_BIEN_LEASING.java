...
public class MAE_CONTRATO_TIPO_BIEN_LEASING {
	...
	public Integer getCod_tipo_bien() {
		return cod_tipo_bien;
	}
	public void setCod_tipo_bien(Integer cod_tipo_bien) {
